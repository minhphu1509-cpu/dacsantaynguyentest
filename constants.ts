...
export const COLORS = {
  ...
  secondary: "#78350f", // amber-900 (wood brown)
...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    category: "Cà Phê",
    price: 285000,
    description: "Hạt cà phê Robusta chế biến theo phương pháp Honey, mang lại vị ngọt hậu tự nhiên và hương thơm nồng nàn của hoa cà phê.",
  ...
  },
  {
    ...
    price: 350000,
    description: "Hạt mắc ca tuyển chọn kích thước lớn, sấy lạnh giữ nguyên hàm lượng dầu tự nhiên, giòn tan và béo ngậy.",
  ...
  },
  {
    ...
    category: "Gia Vị",
    price: 180000,
    description: "Hạt tiêu đen chín đỏ trên cây, phơi nắng tự nhiên, cay nồng đậm đà và mùi thơm đặc trưng không lẫn lộn.",
    image: "https://images.unsplash.com/photo-1599940824399-b87987cb972d?auto=format&fit=crop&q=80&w=1200",
    unit: "Gói 200g"
  },
  {
    id: "4",
    ...
    category: "Mật Ong",
    price: 450000,
    description: "Mật ong đa hoa khai thác trực tiếp từ rừng già Tây Nguyên, vị ngọt thanh, đặc quánh và không bị đóng đường.",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1536620239015-611b33937d57?auto=format&fit=crop&q=80&w=1200",
    unit: "Hộp 500g"
  },
  {
    id: "6",
    ...
    category: "Trà",
    price: 420000,
    description: "Búp trà Oolong 1 tôm 2 lá từ cao nguyên Lâm Đồng, nước trà vàng xanh, hương thơm dịu nhẹ kéo dài.",
    image: "https://images.unsplash.com/photo-1563911191333-dc06371859f2?auto=format&fit=crop&q=80&w=1200",
    unit: "Gói 250g"
  }
];
...
export const INITIAL_BLOG_POSTS: BlogPost[] = [
  {
    ...
    date: "2024-05-10",
    author: "Mr Táo",
    image: "https://images.unsplash.com/photo-1528751004148-73602167195c?auto=format&fit=crop&q=80&w=1200"
  },
  {
    id: "b2",
...
export const INITIAL_FAQS: FAQItem[] = [
  {
    question: "Sản phẩm Mr Táo có đạt chuẩn xuất khẩu không?",
    answer: "Tất cả các dòng sản phẩm của chúng tôi đều đạt chứng nhận VietGAP và được kiểm định định kỳ về dư lượng thuốc bảo vệ thực vật, đảm bảo tiêu chuẩn sạch khắt khe nhất."
  },
  {
    question: "Chính sách đại lý của Mr Táo như thế nào?",
    answer: "Chúng tôi có chính sách chiết khấu linh hoạt từ 15-35% tùy sản lượng, đồng thời hỗ trợ thiết kế bao bì thương hiệu riêng cho đối tác sỉ số lượng lớn."
  }
];
...
export const INITIAL_TEAM: TeamMember[] = [
  {
    ...
    bio: "Hơn 15 năm gắn bó với cây cà phê, Mr Táo là người trực tiếp kiểm soát quy trình rang xay để đảm bảo từng mẻ cà phê luôn đạt chất lượng tốt nhất."
  },
  {
    name: "Nguyễn Thu Hà",
    role: "Giám đốc Chất lượng (QC)",
    image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=600",
    bio: "Chuyên gia với bằng cấp quốc tế về thử nếm (Cupping), phụ trách khâu chọn lọc nguyên liệu đầu vào từ các trang trại liên kết."
  }
];
...
export const INITIAL_PROMOTIONS: Promotion[] = [
  ...
  {
    id: "promo2",
    title: "Ưu Đãi Cà Phê Mới",
    description: "Dùng thử dòng Robusta Honey mới với giá ưu đãi",
    discount: "15%",
